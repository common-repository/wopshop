                ...
                <div class="item_option">            
                    <div class="carbonads">
                        <div class="carbonads-image">
                             <a href="<?php echo esc_url($item[1])?>" class="carbon-img" rel="noopener">
                                <img class="img-responsive" src="<?php print esc_url(WOPSHOP_PLUGIN_URL.'assets/images/new_icons/'.$item[2])?>" alt="" border="0">
                            </a>                           
                        </div>
                        <div class="carbonads-text">
                                ...
                                <div class="carbon-poweredby" rel="noopener"><?php echo $item[4]; ?></div>                            
                        </div>                  
                    </div>
                </div>            
            <?php } ?>
