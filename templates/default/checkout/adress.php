...
<div id="wshop_plugin">
    ...
    <div class="wshop address_block">
        ...
        ?>
        <form action = "<?php print esc_url($this->action)?>" method = "post" name = "loginForm" onsubmit = "return validateCheckoutAdressForm('<?php print esc_url($this->live_path) ?>', this.name)" class = "form-horizontal" autocomplete="off" enctype="multipart/form-data">
            <?php print $this->_tmp_ext_html_address_start; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped?>
            <div class = "wshop_register">
                ...
                <div class = "control-group">
                  <div class = "control-label name">
                    <?php print esc_html(WOPSHOP_EMAIL2) ?> <?php if ($config_fields['email2']['require']){?><span>*</span><?php } ?>
                  </div>
                  <div class = "controls">
                    <input type = "text" name = "email2" id = "email2" value = "<?php print esc_attr($this->user->email) ?>" class = "input" />
                  </div>
                </div>
                <?php } ?> 
                ...
                <?php } ?>
                <?php echo $this->_tmpl_address_html_2; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped?>
                ...
                <?php } ?>
                <?php echo $this->_tmpl_address_html_3; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped?>
                ...
                <?php } ?>
                <?php echo $this->_tmpl_address_html_4; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped?>
            </div>
            ...
            <div id = "div_delivery" class = "wshop_register" style = "padding-bottom:0px;<?php if (!$this->delivery_adress){ ?>display:none;<?php } ?>">
                ...
                <?php } ?>
                <?php echo $this->_tmpl_address_html_5; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped?>
                ...
                <div class = "control-group">
                    ...
                    <?php if ($config_fields['d_street_nr']['display']){?>
                        <input type="text" name="d_street_nr" id="d_street_nr" value="<?php print esc_attr($this->user->d_street_nr)?>" class="inputbox" />
                    <?php }?>
                    </div>
                </div>
                <?php } ?>
                ...
                <?php } ?>
                <?php echo $this->_tmpl_address_html_6; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped?>
                ...
                <?php } ?>                    
                <?php echo $this->_tmpl_address_html_7; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped?>
            </div>
            ...
            <?php } ?>    
            <?php print $this->_tmp_ext_html_address_end; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped?>
            
            <div class = "control-group box_button">
                <div class = "controls">
                    <?php echo $this->_tmpl_address_html_8; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped?>
                    <div class="requiredtext">* <?php print esc_html(WOPSHOP_REQUIRED)?></div>
                    <?php echo $this->_tmpl_address_html_9; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped?>
                    <input type = "submit" name = "next" value = "<?php print esc_attr(WOPSHOP_NEXT)?>" class = "btn btn-primary button" />
                </div>
            </div>
        </form>
    </div>
...
if ($config_fields['birthday']['display'] || $config_fields['d_birthday']['display']){
    ...
    jQuery('#birthday').datepicker({dateFormat: '".esc_js($this->format)."'});
    jQuery('#d_birthday').datepicker({dateFormat: '".esc_js($this->format)."'});
})");
}
 ?>